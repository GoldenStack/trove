...
public record SequenceEntry(@NotNull List<LootEntry<ItemStack>> children, @NotNull List<LootCondition<ItemStack>> conditions) implements LootEntry<ItemStack> {
     ...
     */
    public static final @NotNull KeyedLootConverter<ItemStack, SequenceEntry> CONVERTER = Utils.createKeyedConverter("minecraft:sequence", new TypeToken<>(){},
            ...
            }, (input, context) -> new SequenceEntry(
